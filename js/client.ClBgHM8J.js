...
const M = g(k, [
    ...
    T = () => {
        ...
        return /trident/i.test(n[1]) ? (e = /\brv[ :]+(\d+)/g.exec(t) || [], {
            ...
            name: "Opera",
            version: e[1]
        } : (n = n[2] ? [n[1], n[2]] : [navigator.appName, navigator.appVersion, "-?"], (e = t.match(/version\/(\d+)/i)) != null && n.splice(1, 1, e[1]), {
            name: n[0],
            version: n[1]
        })
    };
...
function j(t) {
    ...
    if (typeof t == "object") {
        const {
            ...
            path: s,
            hash: a
        } = t, i = o ? `?${new URLSearchParams(o)}` : "";
        s ? window.location.assign(`${s}${i}`) : window.history.pushState(null, null, i), a && S({
            linkToSection: a,
            isInstant: n
        })
...
const d = t => {
        t.component("RouterLink", M), t.config.globalProperties.$router = {
            push: e => j(e)
        }, t.directive(E, O)
    },
    ...
    x = async t => {
        ...
        const a = e.name ? `${e.name} Host` : void 0,
            i = {};
        for (const [r, m] of Object.entries(o)) i[r] = () => c(H, {
            value: m,
        ...
        const l = s !== "only",
            u = (l ? y : A)({
                ...
                render() {
                    let r = c(e, n, i);
                    return N(e.setup) && (r = c(v, null, r)), r
                }
            });
        await x(u), u.mount(t, l), t.addEventListener("astro:unmount", () => u.unmount(), {
            once: !0
        })
    };
