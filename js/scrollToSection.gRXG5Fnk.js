...
const L = Symbol("_vod"),
    Ge = {
        beforeMount(t, {
            ...
            t[L] = t.style.display === "none" ? "" : t.style.display, n && e ? n.beforeEnter(t) : N(t, e)
        },
        mounted(t, {
            value: e
        }, {
        ...
        updated(t, {
            ...
            !e == !n && t.style.display === t[L] || (s ? e ? (s.beforeEnter(t), N(t, !0), s.enter(t)) : s.leave(t, () => {
                N(t, !1)
            }) : N(t, e))
        },
        beforeUnmount(t, {
...
function x(t, e) {
    ...
    else if (t.type === Ct) t.children.forEach(n => x(n, e));
    else if (t.type === Xt) {
        let {
            el: n,
            anchor: s
...
function Se(t, e, n) {
    ...
    L in t && (t[L] = a ? s.display : "", s.display = r)
}
...
const ft = t => t.charCodeAt(0) === 111 && t.charCodeAt(1) === 110 && t.charCodeAt(2) > 96 && t.charCodeAt(2) < 123,
    _e = (t, e, n, s, o, r, a, i, f) => {
        const c = o === "svg";
        e === "class" ? ge(t, s, c) : e === "style" ? Se(t, n, s) : Jt(e) ? Qt(e) || ye(t, e, n, s, a) : (e[0] === "." ? (e = e.slice(1), !0) : e[0] === "^" ? (e = e.slice(1), !1) : Pe(t, e, s, c)) ? Te(t, e, s, r, a, i, f) : (e === "true-value" ? t._trueValue = s : e === "false-value" && (t._falseValue = s), be(t, e, s, c))
    };
